...
`ft_irc` is a project which you may do during your cursus, and if you're reading this then I assume you are. It's a cool project, and resolves around you developing an IRC (Internet Relay Chat) server. It's not that hard, although it will challenge your understanding of bi-directional file-descriptor communication.
