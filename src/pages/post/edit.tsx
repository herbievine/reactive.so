...
const Edit: NextPage<IEditProps> = () => {
  ...
  useEffect(() => {
    if (status === "unauthenticated") {
      signIn("github", { callbackUrl: "/post/edit" });
    }
  }, [status]);

  // useEffect(() => {
  //   if (typeof query?.slug !== "string" && !isLoading) push("/");
  // }, [query, isLoading, push]);

  return (
    <Root>
      {/* TODO finish an edit panel */}
