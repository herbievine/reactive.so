...
description: I often get stuck with TypeScript, and when I do, I want to throw my Mac out of the window. So I've created this article, to help you and I write better code. I'll be updating this post when I stumbled upon new and useful TypeScript hacks. In the meantime, feel free to get inspired to create your own cool TS magic, or to just steal some code, I won't judge… 😜
date: 2022-08-12
---
