...
description: Bun is a new JS runtime, similar to Node. Unlike Node, however, Bun is insanely fast. We'll look at that later though, let's first look at the existing problem with Node.
date: 2022-08-05
---
