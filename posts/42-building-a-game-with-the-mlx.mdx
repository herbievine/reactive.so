...
We will be looking into each function in more detail later, but if you want more information about these functions, I recommend visiting 42Docs, as they have done a great job documenting the MLX (linked at the end).
...
Before loading your textures, you may notice you don't have any textures. Here is a quick way to get some basic assets, and make them ready for MLX:
